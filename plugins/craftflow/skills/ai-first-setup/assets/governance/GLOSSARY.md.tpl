...
| **AIDLC** | AI development lifecycle: router, planner, builder, reviewers, verifier, memory files. |
...
| **Plan** | An AIDLC-generated execution plan under `docs/plans/` that phases and gates the implementation. |

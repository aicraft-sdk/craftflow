...
```md
### Live Verification Strategy
- Manifest: `plugins/craftflow/tests/live/manifests/<name>.json`
...
```bash
python3 plugins/craftflow/scripts/craftflow_live_harness_runner.py --manifest <path> --mode proof
python3 plugins/craftflow/scripts/craftflow_live_harness_runner.py --manifest <path> --mode stress
```
